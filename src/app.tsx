...
import { DownloadInfo, DownloadingInfo, DownloadsList } from "./code/DownloadFromServer";
...
import { GetDownloads, StartDownload, ResumeOrPause, RetryDownload, DeleteDownload } from "./code/FrontendDownloadFunctions";
import addSvg from "../assets/plusicon.svg"
import deleteSvg from "../assets/trash-bin-svgrepo-com.svg"
import { UseDownloadStartRequestQueue } from "./hooks/BrowserDownloadStartRequest";
...
export default function App() {
    ...
    // Even though this variable is not used, it is necessary to keep the websocket connection alive
    const downloadRequestQueue = UseDownloadStartRequestQueue()
    ...
    useEffect(() => {
        if (downloadRequestQueue !== null) {
            startDownloadHelper(downloadRequestQueue, "")
        }
